...
class Functions
{
    public static function encrypt(string $e): string
    {
        $str = '';
    ...
    public static function encrypt_with_key(string $e, string $key): string
    {
        $result = '';
    ...
    public static function decrypt_with_key(string $e, string $key): string
    {
    ...
    public static function redirect(string $url = URL)
    {
        header('location: ' . $url);
    }
     ...
     * @return string
     */
    public static function reduce_string(string $string, int $limit): string
    {
